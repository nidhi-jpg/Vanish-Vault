...
class NotificationAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'recipient', 'sender', 'notification_type', 'priority', 'title', 'is_read', 'created_at'
    ]
    ...
    fieldsets = (
        ('Notification', {
            'fields': ('recipient', 'sender', 'notification_type', 'priority', 'title', 'message')
        }),
        ('Related Items', {
            'fields': ('missing_person', 'sighting')
        }),
        ('Status', {
