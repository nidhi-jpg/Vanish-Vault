...
urlpatterns = [
    ...
    path('admin/user/<int:user_id>/verify/', views.verify_user, name='verify_user'),
    path('admin/missing/<int:case_id>/verify/', views.verify_missing_case, name='verify_missing_case'),
    path('admin/found/<int:case_id>/verify/', views.verify_found_case, name='verify_found_case'),
